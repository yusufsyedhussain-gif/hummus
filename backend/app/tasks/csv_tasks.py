...
_redis_kwargs = {"ssl_cert_reqs": "none"} if settings.CELERY_BROKER_URL.startswith("rediss://") else {}
redis_client = redis.from_url(settings.CELERY_BROKER_URL, **_redis_kwargs)
